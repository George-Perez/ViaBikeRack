...
{
    public class BikeRackController : Controller
    {
        private BikeRackCheckerContext db = new BikeRackCheckerContext();

        // GET: BikeRack
        public ActionResult Index()
        {
            return View(db.BikeRackModels.ToList());
        }

        // GET: BikeRack/Details/5
